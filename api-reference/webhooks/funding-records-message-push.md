...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/V9hKdCChTHquQ6LtTGc9/api-reference/webhooks/funding-records-message-push
---
...
```json
{
    ...
    "refundedTime": "1737452344000",                 // (string: timestamp of refund in milliseconds)   
